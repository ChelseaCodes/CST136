...
TLList<Flight> * City::GetFlightList()
{
	return flight_list;
}


void City::InsertIntoFlightList(Node<Flight> * flight_data)
{
	flight_list->InsertOrdered(flight_data);
}
...
ostream & operator<<(ostream & os, City * data)
{
	os << setw(11) << left << data->GetCode()
		<< setw(15) << left << data->GetName()
		<< setw(15) << left << data->GetMan()
		<< setw(15) << left << data->GetPhone();
	return os;
}
